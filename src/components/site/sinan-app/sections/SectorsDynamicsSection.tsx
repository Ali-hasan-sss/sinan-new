...
import type { AssignSectionRef, ScrollContainerRef } from "../types";

export function SectorsDynamicsSection({
  assignSectionRef,
  scrollContainerRef,
  sectionInViewSectors,
}: {
  assignSectionRef: AssignSectionRef;
  scrollContainerRef: ScrollContainerRef;
  sectionInViewSectors: boolean;
}) {
  const { t } = useLanguage();

  return (
    <section
      ref={assignSectionRef("sectors")}
      id="sectors"
    ...
    >
      ...
      <motion.div
        ...
        transition={{
          duration: 1,
          delay: sectionInViewSectors ? 0.25 : 0,
          ease: [0.22, 1, 0.36, 1],
        }}
      >
        <img
      ...
      <div
        className={`absolute inset-0 flex flex-col items-center justify-center ${SINAN_SITE_PX} overflow-hidden`}
        style={{ zIndex: 10 }}
      >
        <motion.div
